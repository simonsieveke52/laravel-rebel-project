...
class StateTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	$states =[
			...
			['status' => false, 'id' => '23','name' => 'Puerto Rico','abv' => 'PR','country_id' => '1'],
			['status' => false, 'id' => '54','name' => 'Armed forces africa \\ canada \\ europe \\ middle east','abv' => 'AE','country_id' => '1'],
			['status' => false, 'id' => '55','name' => 'Armed forces america (except canada)','abv' => 'AA','country_id' => '1'],
			['status' => false, 'id' => '56','name' => 'Armed forces pacific','abv' => 'AP','country_id' => '1'],
			['status' => false, 'id' => '57','name' => 'American samoa','abv' => 'AS','country_id' => '1'],
			['status' => false, 'id' => '58','name' => 'Guam gu','abv' => 'GU','country_id' => '1'],
			['status' => false, 'id' => '59','name' => 'Palau','abv' => 'PW','country_id' => '1'],
			['status' => false, 'id' => '60','name' => 'Federated states of micronesia','abv' => 'FM','country_id' => '1'],
			['status' => false, 'id' => '61','name' => 'Northern mariana islands','abv' => 'MP','country_id' => '1'],
			['status' => false, 'id' => '62','name' => 'Marshall islands','abv' => 'MH','country_id' => '1'],
		];
