...
class MailchimpAbandonedCartSyncCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mailchimp:abandoned-cart-sync';
     ...
     * @var string
     */
    protected $description = 'Sync abandoned carts with Mailchimp';
    ...
    public function handle()
    {
        ...
        $orders = Order::with('products')->notConfirmed()
