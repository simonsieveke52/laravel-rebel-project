...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="{{ $dataType->icon }}"></i> Google Orders
        </h1>
        ...
        <a  class="btn btn-info" style="margin-top: 2px; border:none;" target="_blank" href="{{ route('export.orders', 'type=google') }}">Export</a>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select 
                                        ...
                                        <option {{ (request()->get('order_status', '') == 'all' && ! session()->has('google_order_status')) ? 'selected' : '' }} value="all">All</option>

                                        @foreach ($orderStatues as $status)
                                            <option   
                                                @if ( ( request()->get('order_status') !== 'all' && (int) request()->get('order_status', -1) === (int) $status->id) || ( session('google_order_status') !== 'all' && (int) session('google_order_status', -1) === $status->id))
                                                    selected
                                                @endif
                                            ...
                                            @foreach($dataType->browseRows as $row)
                                                    ...
                                                    @if ( $loop->index == 0 )
                                                        ...
                                                        <td class="text-nowrap">
                                                            ...
                                                            <div>
                                                                <code>#{{ $data->google_order_id }}</code>
                                                            </div>
                                                        </td>
                                                    ...
                                                    @elseif( $loop->index == 1 )
                                                        ...
                                                        <td class="text-nowrap">
                                                            ...
                                                            @if ($data->type == 'google')
                                                                <p class="m-0">
                                                                    <span class="badge badge-primary">Google order</span>
                                                                </p>
                                                            @endif
