                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="middle" style="padding: 8px 0px 6px 0px; text-align: center;">
                                            <a style="font-size: 20px; font-family: sans-serif;" href="https://www.fedex.com/apps/fedextrack/index.html?tracknumbers={{ $trackingNumber->number }}&cntry_code=us">{{ $trackingNumber->number }}</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
