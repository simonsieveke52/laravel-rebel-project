                    ...
                    <table style="table-layout: auto !important;" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr width="100%">
                            ...
                            <td class="stack-column-center" width="40%" style="padding: 15px 20px 0px 0px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <h3 style="border-bottom: 1px solid #555555; padding-right: 15px; padding-bottom: 10px; margin: 0 0 0px; text-align: right; font-size: 14px; line-height: 25px; margin-top: 15px;color: #3f3f3f; font-weight: normal;">
            ...
            <tr>
                <td dir="ltr" valign="middle" width="100%" style="padding: 15px 20px; background-color: #ffffff;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr id="table-headers-desktop" style="border-bottom: 1px solid #555555;">
                            <!-- Column : BEGIN -->
                                        ...
                                        <td dir="ltr" valign="middle" style="text-align: center; padding: 10px 0px 6px 0px;">
                                            <a href="{{ route('product.show', $product->slug) }}" target="_blank">
                                                <img  
                                                    ...
                                                    style="height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; max-width: 100px; max-height: 100px;">
                                            </a>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td dir="ltr" valign="middle" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #000; text-align: left;" class="center-on-narrow">
                                            @if( trim($product->name) != '' )
                                                <h4 style="margin: 0px; font-weight: normal; font-size: 14px; line-height: 22px;">
                                                    <a href="{{ route('product.show', $product->slug) }}" target="_blank" style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 18px; line-height: 22px; color: #333333; font-weight: bold;">
                                    ...
                                    <tr>
                                        <td dir="ltr" valign="middle" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #000; padding: 0px; text-align: center;">
                                            <p style="margin: 0; font-size: 18px;">
                                                <span class="mobile-quantity">Quantity:</span> {{ $product->pivot->quantity }}
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="middle" style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #000; padding: 0px; text-align: center;">
                                            <p style="margin: 0; font-size: 18px;">
                                                ${{ number_format(
                                                    is_array($product->pivot->options) && isset($product->pivot->options['final_price']) 
                                                        ? $product->pivot->options['final_price'] 
                                                        : $product->price
                                                , 2) }} 
                                            </p>
                                        </td>
