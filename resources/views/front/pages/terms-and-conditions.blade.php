	...
	<div class="container px-2 mt-3 terms-container">
		<div class="row py-4">
			...
			<div class="col-12 mb-5 px-5">
				...
				<p>This website is operated by Rebel Smuggling. Throughout the site, the terms “we”, “us” and “our” refer to 
					Rebel Smuggling. Rebel Smuggling offers this website, including all information, tools and services available 
				...
				<br>
				<div class="font-weight-bold">SECTION 1 - ONLINE STORE TERMS</div>
				<p>This website is operated by Rebel Smuggling. Throughout the site, the terms “we”, “us” and “our” refer to 
					Rebel Smuggling. Rebel Smuggling offers this website, including all information, tools and services available 
					from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and 
					notices stated here.
				...
				<br>
				<div class="font-weight-bold">SECTION 2 - GENERAL CONDITIONS</div>
				<p>We reserve the right to refuse service to anyone for any reason at any time.
				</p>
				<p>You understand that your content (not including credit card information), may be transferred unencrypted and involve (a) 
				...
				or access to the Service or any contact on the website through which the service is provided, without express written permission 
				by us.
				<p>
				</p>
				<p>Any new features or tools which are added to the current store shall also be subject to the Terms of Service. 
				...
				<p>The headings used in this agreement are included for convenience only and will not limit or otherwise affect these 
					Terms.
				</p>
				<br>
				<div class="font-weight-bold">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</div>
				<p>We are not responsible if information made available on this site is not accurate, complete or current. 
					...
					sole basis for making decisions without consulting primary, more accurate, more complete or more timely sources of 
				...
				<br>
				<div class="font-weight-bold">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</div>
				...
				<br>
				<div class="font-weight-bold">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</div>
				<p>Certain products or services may be available exclusively online through the website. These products or services may 
					have limited quantities and are subject to return or exchange only according to our Return Policy.
				</p>
				<p>We have made every effort to display as accurately as possible the colors and images of our products that appear at the 
					store. We cannot guarantee that your computer monitor's display of any color will be accurate.
				</p>
				<p>We reserve the right, but are not obligated, to limit the sales of our products or Services to any person, geographic 
				...
				<p>We do not warrant that the quality of any products, services, information, or other material purchased or obtained by 
					you will meet your expectations, or that any errors in the Service will be corrected.
				</p>
				<br>
				<div class="font-weight-bold">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</div>
				...
				<p>You agree to provide current, complete and accurate purchase and account information for all purchases made at our 
				...
				<br>
				<div class="font-weight-bold">SECTION 7 - OPTIONAL TOOLS</div>
				<p>We may provide you with access to third-party tools over which we neither monitor nor have any control nor input.
				</p>
				<p>You acknowledge and agree that we provide access to such tools ”as is” and “as available” without any warranties, 
				...
				<p>Any use by you of optional tools offered through the site is entirely at your own risk and discretion and you should 
				...
				<br>
				<div class="font-weight-bold">SECTION 8 - THIRD-PARTY LINKS</div>
				...
				<p>Third-party links on this site may direct you to third-party websites that are not affiliated with us. 
					We are not responsible for examining or evaluating the content or accuracy and we do not warrant and will not 
				...
				<br>
				<div class="font-weight-bold">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</div>
				...
				<p>You agree that your comments will not violate any right of any third-party, including copyright, trademark, privacy, 
					personality or other personal or proprietary right. You further agree that your comments will not contain libelous 
					or otherwise unlawful, abusive or obscene material, or contain any computer virus or other malware that could in 
				...
				<br>
				<div class="font-weight-bold">SECTION 10 - PERSONAL INFORMATION</div>
				<p>Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy.
				</p>
				<br>
				<div class="font-weight-bold">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</div>
				...
				<br>
				<div class="font-weight-bold">SECTION 12 - PROHIBITED USES</div>
				<p>In addition to other prohibitions as set forth in the Terms of Service, you are prohibited from using the site or 
					...
					spider, crawl, or scrape; (j) for any obscene or immoral purpose; or (k) to interfere with or circumvent the s
					ecurity features of the Service or any related website, other websites, or the Internet. We reserve the right to 
					terminate your use of the Service or any related website for violating any of the prohibited uses.
				</p>

				<br>
				<div class="font-weight-bold">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</div>
				...
				<p>You agree that from time to time we may remove the service for indefinite periods of time or cancel the service at 
				...
				<p>In no case shall Rebel Smuggling, our directors, officers, employees, affiliates, agents, contractors, interns, 
					...
					lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort 
					...
					including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as 
					a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via 
					the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion 
				...
				<br>
				<div class="font-weight-bold">SECTION 14 - INDEMNIFICATION</div>
				<p>You agree to indemnify, defend and hold harmless Rebel Smuggling and our parent, subsidiaries, affiliates, partners, 
				...
				<br>
				<div class="font-weight-bold">SECTION 15 - SEVERABILITY</div>
				...
				<br>
				<div class="font-weight-bold">SECTION 16 - TERMINATION</div>
				<p>The obligations and liabilities of the parties incurred prior to the termination date shall survive the termination 
					of this agreement for all purposes.
				</p>
				<p>These Terms of Service are effective unless and until terminated by either you or us. You may terminate these Terms of 
					Service at any time by notifying us that you no longer wish to use our Services, or when you cease using our site.
				</p>
				<p>If in our sole judgment you fail, or we suspect that you have failed, to comply with any term or provision of these 
				...
				<br>
				<div class="font-weight-bold">SECTION 17 - ENTIRE AGREEMENT</div>
				...
				<p>These Terms of Service and any policies or operating rules posted by us on this site or in respect to The Service 
					...
					any prior or contemporaneous agreements, communications and proposals, whether oral or written, between you and 
				...
				<br>
				<div class="font-weight-bold">SECTION 18 - GOVERNING LAW</div>
				<p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed 
					in accordance with the laws of United States.
				</p>
				<br>
				<div class="font-weight-bold">SECTION 19 - CHANGES TO TERMS OF SERVICE</div>
				...
				<p>We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by 
					...
					Your continued use of or access to our website or the Service following the posting of any changes to these Terms 
					of Service constitutes acceptance of those changes.
				</p>
				<br>
				<div class="font-weight-bold">SECTION 20 - CONTACT INFORMATION</div>
				<p>Questions about the Terms of Service should be sent to us at <a href="mailto:support@rebelsmuggling.com">support@rebelsmuggling.com</a>.
				</p>
			</div>
		</div>
	</div>
