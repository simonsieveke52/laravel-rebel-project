	...
	<div class="container px-2 mt-3 terms-container">
		<div class="row py-4">
			...
			<div class="col-12 mb-5 px-5">
				<div class="font-weight-bold">Terms</div>
				...
				<br>
				<div class="font-weight-bold">Use License</div>

				<p>Permission is granted to temporarily download one copy of the materials (information or software) on Quality Calling Inc's web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
					modify or copy the materials; use the materials for any commercial purpose, or for any public display 
					(commercial or non-commercial); iii. attempt to decompile or reverse engineer any software contained on Quality Calling 
					Inc's web site;
			
					remove any copyright or other proprietary notations from the materials; or
					transfer the materials to another person or "mirror" the materials on any other server.
				</p>
				<p>This license shall automatically terminate if you violate any of these restrictions and may be terminated by Quality 
					Calling Inc at any time. Upon terminating your viewing of these materials or upon the termination of this license, 
					you must destroy any downloaded materials in your possession whether in electronic or printed format.
				</p>
				<br>
				<div class="font-weight-bold">Disclaimer</div>
				<p>The materials on Quality Calling Inc's web site are provided "as is". Quality Calling Inc makes no warranties, 
					...
					property or other violation of rights. Further, Quality Calling Inc does not warrant or make any representations 
					concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or 
					otherwise relating to such materials or on any sites linked to this site.
				</p>

				<br>
				<div class="font-weight-bold">Limitations</div>
				<p>In no event shall Quality Calling Inc or its suppliers be liable for any damages (including, without limitation, 
					damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use 
					the materials on Quality Calling Inc's Internet site, even if Quality Calling Inc or a Quality Calling Inc authorized 
				...
				<br>
				<div class="font-weight-bold">Revisions and Errata</div>
				<p>The materials appearing on Quality Calling Inc's web site could include technical, typographical, or photographic 
					errors. Quality Calling Inc does not warrant that any of the materials on its web site are accurate, complete, or 
					current. Quality Calling Inc may make changes to the materials contained on its web site at any time without notice. 
					Quality Calling Inc does not, however, make any commitment to update the materials.
				</p>
				<br>
				<div class="font-weight-bold">Links</div>
				<p>Quality Calling Inc has not reviewed all of the sites linked to its Internet web site and is not responsible for the 
					contents of any such linked site. The inclusion of any link does not imply endorsement by Quality Calling Inc of the 
					site. Use of any such linked web site is at the user's own risk.
				</p>
				<br>
				<div class="font-weight-bold">Site Terms of Use Modifications</div>
				<p>Quality Calling Inc may revise these terms of use for its web site at any time without notice. By using this web site 
					you are agreeing to be bound by the then current version of these Terms and Conditions of Use.
				</p>
				<br>
				<div class="font-weight-bold">Governing Law</div>
				<p>Any claim relating to Quality Calling Inc's web site shall be governed by the laws of the State of Georgia without 
				...
				<ul>
					...
					<li>We will collect and use of personal information solely with the objective of fulfilling those purposes specified 
					...
					<li>We will protect personal information by reasonable security safeguards against loss or theft, as well as 
