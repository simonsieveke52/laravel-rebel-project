...
<html lang="en">
    <head>
        ...
        <script async defer>
            var resource = document.createElement('link'); resource.setAttribute("rel", "stylesheet");resource.setAttribute('href', 'https://fonts.googleapis.com/css?family=Nunito:300,400,700&display=swap');document.getElementsByTagName('head')[0].appendChild(resource);
        </script>
