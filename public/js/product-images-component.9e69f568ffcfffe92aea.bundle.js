  ...
  computed: {
    images: function images() {
      ...
      for (var i = 0; i < this.productOptions.length; i++) {
        console.log(this.productOptions[i].images[0].src);
        images.push('/storage/products/productImages/' + this.productOptions[i].images[0].src);
      }
    ...
    [
      ...
      _vm.images.length > 0
        ? _c(
            ...
            _vm._l(_vm.images | (_vm.orderBy - 1), function(image) {
              return _c(
                "a",
                {
                  class:
                    image == _vm.selectedImage
                      ? "border mb-3 product-small-image-container d-flex mx-3 align-items-center justify-content-center p-3 border-primary"
                      : "border mb-3 product-small-image-container d-flex mx-3 align-items-center justify-content-center p-3",
                  on: {
                    click: function($event) {
                      return _vm.updateCurrentImage(image)
                    }
                  }
                },
                [
