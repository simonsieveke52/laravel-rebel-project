...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateCurrentImage: function updateCurrentImage(image) {
      ...
      this.selectedImage = image.includes('storage/product-images/') === false ? '/public/images/' + image : image;
      return;
    },
  ...
  computed: {
    images: function images() {
      ...
      for (var i = 0; i < this.productOptions.length; i++) {
        ...
        images.push(this.productOptions[i].images[0].src);
      }
              ...
              return _c(
                ...
                [
                  _c("img", {
                    ...
                    attrs: { src: "/storage/products/productImages/" + image }
                  })
                ]
              )
            }),
