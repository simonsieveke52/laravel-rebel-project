...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.productOptions.length > 0) {
      this.productOptions.map(function (p) {
        if (p.id === _this.currentProduct.id) {
          _this.currentProduct = p;
        }
      });
    }
  },
  ...
  return _c("section", [
    ...
    _c("div", { staticClass: "col-lg-6" }, [
      ...
      _c(
        ...
        [
          _c("money-component", {
            staticClass: "text-decoration-line-through font-weight-light",
            attrs: { value: _vm.currentProduct.original_price }
          }),
          _vm._v(" "),
          _c("money-component", {
            staticClass: "text-highlight font-weight-bold h3",
      ...
      _vm._v(" "),
      _vm.productOptions.length > 0
        ? _c("div", { staticClass: "d-block d-lg-none my-4" }, [
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.currentProduct,
                    expression: "currentProduct"
                  }
                ],
                staticClass: "form-control rounded-sm",
                on: {
                  change: function($event) {
                    ...
                    _vm.currentProduct = $event.target.multiple
                      ? $$selectedVal
                      : $$selectedVal[0]
                  }
                }
              },
              _vm._l(_vm.productOptions, function(p) {
      ...
      _vm._v(" "),
      _vm.productOptions.length > 0
        ? _c("div", { staticClass: "d-none d-lg-block my-4 pt-1 pb-2" }, [
            _c("label", { staticClass: "font-weight-bold" }, [
              _vm._v("Select an option")
            ]),
            _vm._v(" "),
      ...
      _c("div", { staticClass: "mt-4" }, [
        _c(
          "h2",
          {
            staticClass: "h6 mb-3 font-weight-bold cursor-pointer",
            attrs: { id: "bulk-price" },
            on: {
              click: function($event) {
                $event.preventDefault()
