    ...
    quantity: {
      ...
      set: function set(newValue) {
        ...
        this.ajaxRequest = $.ajax({
          ...
          console.log(data); // self.item.bulkPrice = 
          ...
          _c(
            ...
            [
              ...
              _c(
                ...
                [
                  _c(
                    "a",
                    {
                      staticClass: "mb-2 d-block text-wrap small text-left",
                      attrs: {
              ...
              _c(
                "div",
                {
                  staticClass: "py-2 text-dark text-right px-2",
                  on: {
                    click: function($event) {
                      $event.stopPropagation()
                      $event.preventDefault()
                    ...
                    _c("div", [
                      _vm.item.bulkPrice < _vm.item.price
                        ? _c(
                            ...
                            {
                              staticClass:
                                "text-decoration-line-through text-danger small"
                            },
                            [
                              _vm._v(
                                "\n                        " +
                                  _vm._s(_vm._f("currency")(_vm.item.price)) +
                                  "\n                    "
                              )
                            ]
                          )
