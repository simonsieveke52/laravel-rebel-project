...
/* WEBPACK VAR INJECTION */(function($) {!(function webpackMissingModule() { var e = new Error("Cannot find module './components/product/Carousel.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    Carousel: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/product/Carousel.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  props: ['product'],
  data: function data() {
    return {
