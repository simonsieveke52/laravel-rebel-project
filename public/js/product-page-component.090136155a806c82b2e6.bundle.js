  ...
  return _c("section", [
    ...
    _c("div", { staticClass: "col-lg-6" }, [
      ...
      _c("div", { staticClass: "mt-3" }, [
        _c(
          "h1",
          { staticClass: "h6 font-weight-bold", attrs: { id: "bulk-price" } },
          [_vm._v("Share")]
        ),
        _vm._v(" "),
              ...
              "a",
              {
                ...
                attrs: {
                  ...
                  href:
                    ...
                    _vm.route("product.show", _vm.currentProduct.slug).url() +
                    "&media=" +
                    (_vm.window.origin + "/" + _vm.currentProduct.main_image) +
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "list-inline-item px-1" }, [
      _vm._v(
        ' " . $product->name . \' \'. PHP_EOL . url()->full() }}" class="text-red">\n\t\t\t\t\t\t'
      ),
