...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      selectedImage: this.product.images !== undefined && this.product.images.length > 0 ? '/storage/products/productImages/' + this.product.images[0].src : '/storage/notfound.jpg'
    };
  },
  watch: {
  ...
  methods: {
    updateCurrentImage: function updateCurrentImage(image) {
      this.selectedImage = '/storage/products/productImages/' + image;
    },
  ...
  return _c(
    ...
    [
      _c(
        "a",
        {
          staticClass: "link--gallery-zoom",
          attrs: { href: "#", title: "click to zoom" },
          on: {
